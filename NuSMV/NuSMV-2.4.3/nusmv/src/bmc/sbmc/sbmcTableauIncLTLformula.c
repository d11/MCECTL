...
static char rcsid[] UTIL_UNUSED = "$Id: sbmcTableauIncLTLformula.c,v 1.1.2.4.4.3 2007/05/21 07:29:03 nusmv Exp $";
                                           ...
                                           const int do_optimization)
{
  ...
  snprintf(str_debug2, 32, " at timestep %u\n", i_model);
                                      ...
                                      const int do_optimization)
{
  ...
  sprintf(str_debug2, " at timestep %u\n", i_model);
