...
/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: BeEnc.h,v 1.1.2.6.6.1 2007/04/20 13:05:54 nusmv Exp $]
...
typedef enum BeVarType_TAG {
  ...
  BE_VAR_TYPE_INPUT  = 0x1 << 1, 
  BE_VAR_TYPE_NEXT   = 0x1 << 2
} BeVarType;
...
EXTERN boolean 
BeEnc_is_index_untimed_curr_input ARGS((const BeEnc_ptr self, 
                                        const int index));
