...
void	get_one(mealy<int, int>& a, int argc, char** argv, char* my_name); 
void	get_two(mealy<int, int>& a, mealy<int, int>& b, int argc, char** argv, char* my_name); 
void	get_one(re<pair<int, int> >& a, int argc, char** argv, char* my_name); 
void	get_two(re<pair<int, int> >& a, re<pair<int, int> >& b, int argc, char** argv, char* my_name); 
...
{ 
	...
	{ 
		int			i = 100; 
		set<string<pair<int, int> > >	results;	 
...
void 
get_two(mealy<int, int>& a, mealy<int, int>& b, int argc, char** argv, char* my_name) 
{ 
	fstream	f_arg; 
	fstream	g_arg; 
...
void 
get_one(mealy<int, int>& a, int argc, char** argv, char* my_name) 
{ 
	fstream		f_arg; 
...
void 
get_two(re<pair<int, int> >& a, re<pair<int, int> >&b, int argc, char** argv, char* my_name) 
{ 
	fstream	f_arg; 
	fstream	g_arg; 
...
void 
get_one(re<pair<int, int> >& a, int argc, char** argv, char* my_name) 
{ 
	fstream		f_arg; 
