/**CFile***********************************************************************
  ...
  Revision    [$Id: PrinterPsl.c,v 1.1.2.5.4.2 2007/01/03 13:37:51 nusmv Exp $]
...
static char rcsid[] UTIL_UNUSED = "$Id: PrinterPsl.c,v 1.1.2.5.4.2 2007/01/03 13:37:51 nusmv Exp $";
  ...
  case PSL_EVENTUALLYBANG:
    {
      ...
      default: nusmv_assert(false); /* no other cases */
      }
  ...
  case PSL_WITHIN_:
    {
      ...
      default: nusmv_assert(0); /* no other cases here */
      }
