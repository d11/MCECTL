/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: sbmcUtils.h,v 1.1.2.6.4.2 2007/04/05 13:26:32 nusmv Exp $]
...
EXTERN Trace_ptr Sbmc_Utils_generate_and_print_cntexample ARGS((BeEnc_ptr be_enc, 
...
EXTERN lsList sbmc_MS_get_model ARGS((sbmc_MetaSolver *ms));
