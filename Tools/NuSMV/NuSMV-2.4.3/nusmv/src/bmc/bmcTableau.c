...
static char rcsid[] UTIL_UNUSED = "$Id: bmcTableau.c,v 1.6.4.5.2.2.2.2 2005/03/03 12:32:04 nusmv Exp $";
...
******************************************************************************/
be_ptr Bmc_Tableau_GetLtlTableau ARGS((const BeFsm_ptr be_fsm,
				       const node_ptr ltl_wff,
				       const int k, const int l))
{
