/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: BddEnc_private.h,v 1.1.2.7.2.1.2.6.4.11 2007/04/20 13:05:54 nusmv Exp $]
...
typedef struct BddEnc_TAG
{
  ...
  /* used to create blocks of variables */
  int block_index;
  size_t block_size;
  int curr_block_num;
  ...
  array_t* minterm_state_input_vars; /* array of bdd_ptr */
  ...
  add_ptr state_vars_mask_add;
  add_ptr state_input_vars_mask_add;

  bdd_ptr input_vars_mask_bdd;
  bdd_ptr state_vars_mask_bdd;
  bdd_ptr state_input_vars_mask_bdd;
...
/* 
   ...
   At the moment it is used by MBP module
*/
