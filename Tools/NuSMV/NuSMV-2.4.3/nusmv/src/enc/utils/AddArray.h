/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: AddArray.h,v 1.1.2.2.6.5 2007/04/20 13:05:54 nusmv Exp $]
...
EXTERN AddArray_ptr AddArray_word_uminus ARGS((DdManager* dd, 
                                               AddArray_ptr arg));
...
EXTERN AddArray_ptr AddArray_word_times ARGS((DdManager* dd,
                                              AddArray_ptr arg1,
                                              AddArray_ptr arg2));
EXTERN AddArray_ptr AddArray_word_divide ARGS((DdManager* dd,
                                               AddArray_ptr arg1,
                                               AddArray_ptr arg2));
EXTERN AddArray_ptr AddArray_word_mod ARGS((DdManager* dd,
                                            AddArray_ptr arg1,
                                            AddArray_ptr arg2));
...
EXTERN AddArray_ptr AddArray_word_left_shift ARGS((DdManager* dd,
                                                   AddArray_ptr arg,
                                                   AddArray_ptr number));
EXTERN AddArray_ptr AddArray_word_right_shift ARGS((DdManager* dd,
                                                    AddArray_ptr arg,
                                                    AddArray_ptr number));
...
EXTERN AddArray_ptr AddArray_word_less ARGS((DdManager* dd,
                                             AddArray_ptr arg1,
                                             AddArray_ptr arg2));
EXTERN AddArray_ptr AddArray_word_less_equal ARGS((DdManager* dd,
                                                   AddArray_ptr arg1,
                                                   AddArray_ptr arg2));
EXTERN AddArray_ptr AddArray_word_greater ARGS((DdManager* dd,
                                                AddArray_ptr arg1,
                                                AddArray_ptr arg2));
EXTERN AddArray_ptr AddArray_word_greater_equal ARGS((DdManager* dd,
                                                      AddArray_ptr arg1,
                                                      AddArray_ptr arg2));

EXTERN AddArray_ptr 
AddArray_word_signed_less ARGS((DdManager* dd, 
                                AddArray_ptr arg1, AddArray_ptr arg2));

EXTERN AddArray_ptr 
AddArray_word_signed_less_equal ARGS((DdManager* dd, 
                                      AddArray_ptr arg1, AddArray_ptr arg2));

EXTERN AddArray_ptr 
AddArray_word_signed_greater ARGS((DdManager* dd, 
                                   AddArray_ptr arg1, AddArray_ptr arg2));

EXTERN AddArray_ptr 
AddArray_word_signed_greater_equal ARGS((DdManager* dd, 
                                         AddArray_ptr arg1, 
                                         AddArray_ptr arg2));
EXTERN AddArray_ptr 
AddArray_word_sign_extend ARGS((DdManager* dd,
