/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: PredicateNormaliser.h,v 1.1.2.1.6.1 2007/05/09 15:43:28 nusmv Exp $]
******************************************************************************/
...
PredicateNormaliser_create ARGS((TypeChecker_ptr checker));
...
EXTERN void 
PredicateNormaliser_print_predicates_only ARGS((FILE* stream,
