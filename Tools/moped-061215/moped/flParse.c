...
#define yyparse         flparse
#define yylex           fllex
#define yyerror         flerror
#define yylval          fllval
#define yychar          flchar
#define yydebug         fldebug
#define yynerrs         flnerrs
...
static const yytype_uint8 yyprhs[] =
{
      ...
      25,    29,    32,    35,    39,    43,    47
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      25,     0,    -1,    26,    -1,    16,    -1,     3,    -1,     4,
      -1,    26,     7,    26,    -1,    26,     6,    26,    -1,     5,
      26,    -1,     8,    26,    -1,    26,     9,    26,    -1,    11,
      26,    -1,    10,    26,    -1,    19,    26,    20,    -1,    21,
      27,    22,    -1,    23,    16,    23,    -1,    16,    18,    16,
      -1
};
...
{
       0,    57,    57,    65,    67,    68,    69,    73,    77,    80,
      83,    87,    90,    94,    97,   100,   165
};
#endif
...
{
  "$end", "error", "$undefined", "TR", "FA", "NOT", "OR", "AND", "NEXT",
  "UNTIL", "GLOBAL", "EXIST", "ERROR", "LESSEQ", "MOREEQ", "UNEQ", "IDENT",
  "LANGUAGE", "OPERATOR", "'('", "')'", "'{'", "'}'", "'\"'", "$accept",
  "startsym", "formel", "varexpr", 0
};
#endif
...
{
       0,     4,     5,     0,     0,     0,     0,     3,     0,     0,
       0,     0,     2,     8,     9,    12,    11,     0,     0,     0,
       0,     1,     0,     0,     0,    13,     0,    14,    15,     7,
       6,    10,    16
};
...
{
       6,   -11,   -11,     6,     6,     6,     6,   -11,     6,   -10,
      -8,    12,    24,    24,    24,    24,    24,    17,    -5,    -7,
       5,   -11,     6,     6,     6,   -11,     2,   -11,   -11,    23,
      -2,   -11,   -11
};
...
{
      13,    14,    15,    16,    22,    17,    18,    24,    20,     1,
       2,     3,    21,    26,     4,    27,     5,     6,    32,    29,
      30,    31,     7,    22,    23,     8,    24,     9,    28,    10,
      22,    23,    24,    24,     0,     0,     0,    25
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,     6,     8,    16,     9,    16,     3,
       4,     5,     0,    18,     8,    22,    10,    11,    16,    22,
      23,    24,    16,     6,     7,    19,     9,    21,    23,    23,
       6,     7,     9,     9,    -1,    -1,    -1,    20
};
...
{
       0,     3,     4,     5,     8,    10,    11,    16,    19,    21,
      23,    25,    26,    26,    26,    26,    26,    26,    16,    27,
      16,     0,     6,     7,     9,    20,    18,    22,    23,    26,
      26,    26,    16
};
...
#line 57 "flParse.y"
    { // at the end the result is stored on the top of the stack
				  ...
				  fprintf(flout, "%s", (yyvsp[(1) - (1)].string));
